...
function StickerPlaceholder({ height = 400 }: { height?: number }) {
  return (
    <div
      className="w-full rounded-[36px] flex flex-col items-center justify-center"
      style={{
        height,
...
function Separator() {
  return (
    <div className="flex items-center gap-5">
      ...
      <div
        className="w-3.5 h-3.5 rotate-45 border border-[#C9A84C]/35"
        ...
        >
          ...
          <div className="relative z-10 flex flex-col items-center w-full h-full px-14">
            ...
            <div className="flex items-center gap-5 pt-[110px]">
              ...
              <div>
                <p className="font-(family-name:--font-playfair) text-[30px] font-bold text-[#F5F0E8]/90">
                  Episteme
                </p>
                <p className="font-(family-name:--font-inter) text-[20px] text-[#C9A84C]/45 tracking-wide">
                  @asso_episteme
                </p>
              </div>
            </div>
